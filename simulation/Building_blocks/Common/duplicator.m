function [out_signal1,out_signal2] = duplicator(in_signal,model,plot_info,varargin)
...
[out_signal1, out_signal2] = DC1(in_signal, in_signal2, model,DC1_plot,DC1_varargin{:});
...
if out_signal_plot_flag == 1
    signal_plotting([out_signal1;out_signal2],model,'Out signal 1','Out signal 2');
    fprintf('\n Duplicator: Out signal 1 = u(t-t0) a sin(2 \x03c0 f t + \x03c6), where t0 = %d ns, a = %d, f = %d GHz and \x03c6 = %d, normalized power = %d%% \n',out_signal1(4),out_signal1(1),out_signal1(2),out_signal1(3),normalization(out_signal1(1),model))
    fprintf('\n Duplicator: Out signal 2 = u(t-t0) a sin(2 \x03c0 f t + \x03c6), where t0 = %d ns, a = %d, f = %d GHz and \x03c6 = %d, normalized power = %d%% \n',out_signal2(4),out_signal2(1),out_signal2(2),out_signal2(3),normalization(out_signal2(1),model))
end
