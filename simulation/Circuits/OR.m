function [OR_out] = OR(in_A,in_B,model_parameters,plot_info, varargin)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% OR %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[S,C] = HA(in_A,in_B,model_parameters,HA_plot, HA_varargin{:});
[OR_out,~] = HA(S,C,model_parameters,HA_plot, HA_varargin{:});
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%% optional operation %%%%%%%%%%%%%%%%%%%%%%%%
if out_signal_plot_flag == 1
    signal_plotting(OR_out,model_parameters,'OR out');
    fprintf('\n OR: OR_out = u(t-t0) a sin(2 \x03c0 f t + \x03c6), where t0 = %d ns, a = %d, f = %d GHz and \x03c6 = %d, normalized power = %d%% \n',OR_out(4),OR_out(1),OR_out(2),OR_out(3),normalization(OR_out(1),model_parameters))
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
end
